      ...
      <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          <h2 className="text-2xl font-bold text-primary mb-2 flex items-center gap-2">
            <span role="img" aria-label="Plate and cutlery">🍽️</span> Food Waste Platform
          </h2>
        ...
        <nav aria-label="Footer navigation" className="space-y-3">
          ...
          <ul>
            <li>
              <a href="/about" className="link link-hover text-gray-700 dark:text-gray-300 hover:text-primary transition-colors">
                About Us
              </a>
            </li>
            <li>
              <a href="/contact" className="link link-hover text-gray-700 dark:text-gray-300 hover:text-primary transition-colors">
                Contact
              </a>
            </li>
          </ul>
